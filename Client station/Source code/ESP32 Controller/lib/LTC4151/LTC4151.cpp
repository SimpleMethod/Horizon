...
{
	if (A0 == L && A1 == H)
		I2C_ADDRESS = B1100111;
	else if (A0 == H && A1 == F)
		I2C_ADDRESS = B1101000;
	else if (A0 == H && A1 == H)
		I2C_ADDRESS = B1101001;
	else if (A0 == F && A1 == F)
		I2C_ADDRESS = B1101010;
	else if (A0 == L && A1 == F)
		I2C_ADDRESS = B1101011;
	else if (A0 == H && A1 == L)
		I2C_ADDRESS = B1101100;
	else if (A0 == F && A1 == H)
		I2C_ADDRESS = B1101101;
	else if (A0 == F && A1 == L)
		I2C_ADDRESS = B1101110;
	else if (A0 == L && A1 == L)
		I2C_ADDRESS = B1101111;
}

void LTC4151::init(uint8_t i2c_addr)
{
